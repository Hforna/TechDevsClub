...
namespace Career.Infrastructure.Migrations
{
    ...
    [Migration("20251007194830_addCascadeConfigurationOntables")]
    partial class addCascadeConfigurationOntables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Career.Domain.Aggregates.CompanyRoot.StaffRole", b =>
                {
                    b.HasOne("Career.Domain.Aggregates.CompanyRoot.Staff", "Staff")
                        .WithOne("StaffRole")
                        .HasForeignKey("Career.Domain.Aggregates.CompanyRoot.StaffRole", "StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
