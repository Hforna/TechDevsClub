...
namespace Profile.Infrastructure.Migrations
{
    ...
    [Migration("20250612025245_CreateConnectionsBetweenUsers")]
    partial class CreateConnectionsBetweenUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Connection", b =>
                {
                    b.HasOne("Profile.Domain.Aggregates.User", "Connected")
                        .WithMany()
                        .HasForeignKey("ConnectedId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Profile.Domain.Aggregates.User", "Connector")
                        .WithMany()
